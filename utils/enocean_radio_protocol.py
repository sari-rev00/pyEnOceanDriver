...
def check_erp2_telegram_data():
    sample_data = ['0x20', '0x00', '0x28', '0xe8', '0xce', '0x85', '0x73']
    handler = ERP2()
    resp = handler.get_dict_data(sample_data)
    pprint(resp)
    assert resp == {
        'data': ['0x85'],
        'orig_id': ['0x00', '0x28', '0xe8', '0xce'],
        'tel_type': 'RPS'}, "ERROR: response not correct"
    return None


if __name__ == "__main__":
    check_erp2_telegram_data()
